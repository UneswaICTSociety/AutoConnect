...
# Windows 11 build number where native WiFi connection works reliably
# Build 22000 = Windows 11 initial release (October 2021)
# Newer builds have better WiFi stack that handles WPA2-Enterprise natively
WINDOWS_11_NATIVE_WIFI_MIN_BUILD = 22000

# How long to wait for Windows 11 native credential prompt before assuming failure
# Windows shows its own dialog for WPA2-Enterprise credentials, we give it time
...
WINDOWS_SETTINGS = {
    ...
    "win11_native_wait_seconds": WIN11_NATIVE_WAIT_SECONDS,
}
