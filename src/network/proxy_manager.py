...
class LinuxProxyManager:
    ...
    @staticmethod
    def _add_proxy_to_file(file_path, backup=True):
        try:
    ...
    @staticmethod
    def _remove_proxy_from_file(file_path):
...
def enable_university_proxy():
    
    return proxy_manager.enable_proxy()


def disable_university_proxy():
    
    return proxy_manager.disable_proxy()


def is_university_proxy_configured():
    
    return proxy_manager.is_proxy_configured()


def get_proxy_config_status():
